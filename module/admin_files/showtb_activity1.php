	...
	?>
		...
		?><tr>
					...
					<td><?php echo $fd2['act_des'];?></td>
					  			<td><a href='?fd=admin&page=edittb_activity1&act_id=<?php echo $fd2['act_id'];?>'><img src="img/do.png" height="30" width="30">  </a></td>
	...
	<script type="text/javascript">
		$(document).ready(function(){
           ...
           if(confirm('คุณต้องการลบข้อมูลใช่หรือไม่')){
             var url="module/admin_files/deltb_activity1.php";
