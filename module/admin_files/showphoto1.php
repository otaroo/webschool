...
<div class="w3-row content_box"><?php
	...
	?>
		...
		<tbody><?php 
			$sql2 ="select * from tb_photo where 1  order by act_id asc";  
			$qess2=$db->query($sql2);	
			while($fd2=$qess2->fetch_assoc()){	
			
		?><tr>
					<td><?php echo $fd2['photo_id'];?></td><?php 
							$sql3 ="select act_name name from tb_actvity where act_id='".$fd2['act_id']."'";  
							$qess3=$db->query($sql3);	
					...
					<td><?php echo $fd2['photo_date'];?></td>
					  			<td><a href='editphoto1.php?photo_id=<?php echo $fd2['photo_id'];?>'><img src="img/edit.jpg" height="30" width="30">  </a></td>
					  			<td><span class ="photo_id"><?php echo $fd2['photo_id'];?></span><img class="picdel"  src="img/del.png" height="25" width="25"></td>
					  			<td><a href='showphoto1detail.php?photo_id=<?php echo $fd2['photo_id'];?>'><img src="img/more.png" height="25" width="25">  </a></td>
		  	</tr>
		  	<?php  } ?>
	...
	<script type="text/javascript">
		$(document).ready(function(){
           ...
           if(confirm('คุณต้องการลบข้อมูลใช่หรือไม่')){
             var url="?fd=admin&page=delphoto1.php";
