    ...
    <div class="col-lg-6"></div>
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signup my-5">
          <div class="card-body">
            <h3 class="card-title text-center">ข้อมูลกิจกรรม</h3>
    		...
    		<input type="date" class="form-control" id="activities_date" name="activities_date"  >
				</div>
				<div class="form-group"><label for="activities_place">สถานที่จัดกิจกรรม:</label><label id="err4" class="err"></label>    	
    		<input type="text" class="form-control" id="activities_place" name="activities_place"  >
				</div>
				<div class="form-group"><label for="activities_status">สถานะ:</label><label id="err5" class="err"></label>
					<select  id="activities_status" name="activities_status" class="form-control">
			       		<option value="" disabled >เลือก</option><?php 
		        			...
		        			?><option value="<?php echo $k[$l]; ?>" ><?php echo $_array[$k[$l]];?></option>
							<?php } ?>
			       		</select>
				</div>
				<div class="form-group"><label for="activities_description">รายละเอียดกิจกรรม:</label><label id="err6" class="err"></label>
			<textarea class="form-control" rows="5" id="activities_description" name="activities_description"></textarea>
				</div>
		  ...
		  <button type="button" onclick="return checkEmpty();" id="btnAdd" name="btnAdd" class="btn btn-primary">เพิ่มข้อมูล</button>
         ...
         <script language="javascript">
				function checkEmpty()
				{
				 ...
				 $("#err7").html('');
				  ...
				  if(chk){ 
				  	    var url="module/admin_files/activities_save.php";
				  	  	//var url="savetb_activities.php";
				  	    ...
				  	    $.ajax({
					            ...
					            success: function (data) {
					                ...
					                if(data.trim()=='1'){
								  	 ...
								  	 }else $("#status_save").html(data+'<font color=red>ไม่สามารถบันทึกข้อมูลได้...กรุณาตรวจสอบข้อมูลอีกครั้ง...</font><br>');
