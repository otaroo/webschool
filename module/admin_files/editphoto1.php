...
?>
    	<form id="frmedit" name="frmedit"  method="post"  enctype="multipart/form-data">
				...
				<div class="form-group"><label for="act_id">รหัสกิจกรรม:</label><label id="err2" class="err"></label>
					<select  id="act_id" name="act_id" class="form-control">
		       			<option value="" disabled >เลือก</option><?php
							$sql3 ="select act_id id,act_name  name from tb_actvity ";  
							$qess3=$db->query($sql3);	
    		...
    		<input type="date" class="form-control" id="photo_date" name="photo_date" value="<?php echo $row_q['photo_date'] ?>" >
				</div>
				...
				function checkEmpty()
				{
				 ...
				 $("#err4").html('');
				  ...
				  if(chk){ 
				  	    ...
				  	    var url="module/admin_files/updatephoto1.php"
				  		var form = $('#frmedit')[0];
				  	    ...
				  	    $.ajax({
					            ...
					            success: function (data) {
					                ...
					                if(data.trim()=='1'){
								  	 ...
								  	 setTimeout(function(){ 
								       location='?fd=admin&page=showphoto1';
								      }, 3000);  
