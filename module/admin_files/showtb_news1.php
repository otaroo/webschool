...
<link rel="stylesheet" href="css/page-style.css">
  ...
  <p>&nbsp;</p>
  <p><a href="?fd=admin&page=addtb_news1">เพิ่มข่าว
    </a></p>
...
<div class="w3-row content_box"><?php
	...
	?>
		...
		<tbody><?php 
			$sql2 ="select * from tb_news where 1  order by title asc";  
			$qess2=$db->query($sql2);	
		...
		?><tr>
					...
					<td><?php echo $fd2['publish_time'];?></td>
					  			<td><a href='?fd=admin&page=edittb_news1&id=<?php echo $fd2['id'];?>'><img src="img/do.png" height="30" width="30">  </a></td>
	...
	<script type="text/javascript">
		$(document).ready(function(){
           ...
           if(confirm('คุณต้องการลบข้อมูลใช่หรือไม่')){
             var url="module/admin_files/deltb_news1.php";
