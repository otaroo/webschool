...
<div class="w3-row content_box"><?php
	...
	?>
		...
		<tbody><?php 
			$sql2 ="select * from tb_news where 1  order by title desc";  
			$qess2=$db->query($sql2);	
		...
		?><tr>
					...
					<td><?php echo $fd2['publish_time'];?></td>
					  			<td><a href='?fd=admin&page=edittb_news2&?id=<?php echo $fd2['id'];?>'><img src="img/edit.jpg" height="30" width="30">  </a></td>
	...
	<script type="text/javascript">
		$(document).ready(function(){
           ...
           if(confirm('คุณต้องการลบข้อมูลใช่หรือไม่')){
             var url="module/admin_files/deltb_news2.php";
