...
Date Create : 2019-01-23 20:08:01
...
?>
    	<form id="frmedit" name="frmedit"  method="post"  enctype="multipart/form-data">
    		...
    		<input type="text" class="form-control" id="description" name="description" value="<?php echo $row_q['description'] ?>" >
				...
				<div class="form-group"><label for="publish_time">วันที่:</label><label id="err4" class="err"></label>    	
				...
				function checkEmpty()
				{
				 ...
				 $("#err4").html('');
				  ...
				  if(chk){ 
				  	    ...
				  	    var url="module/admin/_files/updatetb_news2.php"
				  		var form = $('#frmedit')[0];
				  	    ...
				  	    $.ajax({
					            ...
					            success: function (data) {
					                ...
					                if(data.trim()=='1'){
								  	 ...
								  	 setTimeout(function(){ 
								       location='?fd=admin&page=showtb_news2';
								      }, 3000);  
