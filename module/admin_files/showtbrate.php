	...
	?>
        ...
        <thead>
			      <tr>
                    ...
                    <th><div align="center">ดูผลการประเมิน</div></th>
		...
		?><tr>
            ...
            <td><div align="center"><a href='?fd=admin&page=tb_rate1&act_id=<?php echo $fd2['act_id'];?>'>ดูผลการประเมิน</td>
             <td><div align="center"><a href='module/view_files/print_rate.php?act_id=<?php echo $fd2['act_id'];?>' target="_blank"><img src="img/ac.png" height="30" width="30">  </a></div></td>
	  	  </tr>
		  	<?php  } ?>
		</tbody>
		</table>
