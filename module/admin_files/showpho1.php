...
Date Create : 2019-01-28 18:54:01
...
<div class="w3-row content_box"><?php
	...
	?>
		...
		<tbody><?php 
			$sql2 ="select * from tb_photo where 1  order by photo_img desc";  
			$qess2=$db->query($sql2);	
			while($fd2=$qess2->fetch_assoc()){	
	
$url_img = "img/act/".$fd2['photo_id'].$fd2['photo_img'];

		?><tr>
					<td><?php echo $fd2['photo_id'];?></td>
					<td><?php echo $fd2['photo_img'];?></td><?php 
					...
					<td><?php echo $fd3['name'];?></td>
					  			<td><a href='?fd=admin&page=editpho1&photo_id=<?php echo $fd2['photo_id'];?>'><img src="img/edit.jpg" height="30" width="30">  </a></td>
	...
	<script type="text/javascript">
		$(document).ready(function(){
           ...
           if(confirm('คุณต้องการลบข้อมูลใช่หรือไม่')){
             var url="?fd=admin&page=delpho1.php";
