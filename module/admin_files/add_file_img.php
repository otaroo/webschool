 ...
 <div style="display:table; margin:0 auto; padding: 20px; width:70%;">
  ...
  <h2>จัดการรูปภาพข่าวประชาสัมพันธ์/กิจกรรมของกศน.</h2>
   ...
   <form name="frm" id="frm" action="#"  method="post" onsubmit="return checkdata();" enctype="multipart/form-data">
    <input name="id_news" id="id_news" type="hidden" value="<?php echo $_GET['id_news'];?>" >
  <br><br><br>
...
$("#fileuploader").uploadFile({
    url: "module/admin_files/upload_mu.php", // Server URL which handles File uploads
...
// alert(55);
 ...
 function getPhoto(){
  ...
  var url="module/admin_files/getPho.php";
  $.post(url,{
    id_news:id_news
    },function (data)  { 
     //alert(data);
