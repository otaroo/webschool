...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2019 at 11:55 AM
...
(51, 'เข้าค่ายกิจกรรม', '2019-03-18', 'นโยบายสถานศึกษา นักศึกษาที่จะจบแต่ละภาคเรียนต้องผ่าานการเข้าคุณธรรมจำนวน 2 วัน และ ได้รับการฝึกอบรมนำไปใช้ในชีวิตประจำวัน', 'ณ วัดนาโบสถ์', '50', '2019-03-17', '2019-04-21'),
(52, 'โครงการสร้างจิตสำนึก', '2019-03-30', 'อบรมการเป็นพลเมืองที่ดีในของระบอบประชาธิปไตย', 'ณ ศาลาเอนกประสงค์ บ้านเพชรชมพู ตำบลนาโบสถ์ อำเภอวังเจ้า จังหวัดตาก 63000', '3', '2019-04-02', '2019-04-03');
...
--
ALTER TABLE `tb_activity`
  MODIFY `act_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสกิจกรรม', AUTO_INCREMENT=54;
...
--
ALTER TABLE `tb_member`
  MODIFY `mem_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสผู้สมัคร', AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT for table `tb_new`
--
ALTER TABLE `tb_new`
  MODIFY `id_news` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสข่าว', AUTO_INCREMENT=12;
...
--
ALTER TABLE `tb_rate`
  MODIFY `rate_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการประเมิน', AUTO_INCREMENT=48;
COMMIT;
