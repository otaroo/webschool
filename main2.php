...
<div class="container">
    ...
    <div class="row">
        <?php
    $sql ="SELECT * FROM tb_new order by id_news  limit 5 ";  
    $qess=$db->query($sql);	
    while($fd=$qess->fetch_assoc()){	?>

        <div class="col-lg-4 mb-4">
            <div class="card h-100">
                <a href="index.php?fd=admin&page=new_detail&id_news=<?php echo $fd['id_news']; ?>"><img class="card-img-top" src="img/new2.jpg" alt="">
